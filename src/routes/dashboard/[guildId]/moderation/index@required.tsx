...
import { CreateOutline, FileTrayFullOutline, NotificationsOffOutline, Ban, ShieldCheckmarkOutline } from 'qwik-ionicons';
...
export default component$(() => {
  ...
  const { guild, channels, roles } = useGetData().value;
