  ...
  return (
    <div class="flex gap-3 items-center">
      <label class="inline-flex relative items-center cursor-pointer">
        ...
        <div class={{
          'transition ease-in-out w-12 h-7 rounded-md peer bg-gray-700 border border-gray-600 hover:bg-gray-600': true,
          'peer-checked:bg-luminescent-700 peer-checked:border-luminescent-600 peer-checked:hover:bg-luminescent-600': true,
          'after:content-[\'\'] after:absolute after:top-[4px] after:left-[4px] after:bg-gray-600 after:border after:border-gray-500 hover:after:bg-gray-500 after:rounded-md after:h-5 after:w-5 after:transition-all after:ease-in-out': true,
