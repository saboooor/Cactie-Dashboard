    ...
    <header>
      <nav class="z-10 fixed top-0 w-screen my-3 pointer-events-none">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <a href={client.user ? '/' : ''} class="pointer-events-auto text-gray-300 bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl pl-2 pr-3 py-2 rounded-full text-sm font-medium flex items-center">
            ...
            <div class="flex-1 items-center hidden justify-center sm:flex">
              <div class="sm:ml-6 sm:block">
                <div class="pointer-events-auto flex space-x-4">
                  <a href="/dashboard" class="text-gray-300 bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl px-3 py-2 rounded-full text-sm font-medium">Dashboard</a>
                  <a href="/discord" class="text-gray-300 bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl px-3 py-2 rounded-full text-sm font-medium">Support</a>
                  <a href="/legal" class="text-gray-300 bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl px-3 py-2 rounded-full text-sm font-medium">Legal</a>
                  <a href="/invite" class="text-gray-300 bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl px-3 py-2 rounded-full text-sm font-medium">Invite</a>
                </div>
              </div>
            </div>
            <div class="flex flex-1 items-center justify-end sm:items-stretch">
              ...
              <a href="/login" id="loggedout" class="pointer-events-auto bg-indigo-700 hover:bg-indigo-600 text-white hover:drop-shadow-2xl px-4 py-2 rounded-full text-sm font-medium hidden items-center">
                Login
              </a>
            </div>
          </div>
        ...
        <div class="hidden" id="mobile-menu">
          <div class="pointer-events-auto space-y-1 py-3 justify-center items-center flex gap-2">
            ...
            <a href="/discord" class="text-gray-300 bg-gray-800 hover:bg-gray-700 hover:text-white hover:drop-shadow-2xl px-4 py-2 rounded-full text-base font-medium">Support</a>
